    ...
    <div class="row mx-n2">
        <div class="col-xl-2 col-lg-4 col-md-6 px-2">
            <select class="custom-select px-4 mb-3" style="height: 50px;">
                ...
                <option value="{{$location->id}}">{{$location->state}} - {{$location->city}} - {{$location->street_address}}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-2">
                <div class="rent-item mb-4">
                    <img class="img-fluid mb-4" src="Website/img/car-rent-1.png" alt="">
            ...
            <div class="col-lg-4 col-md-6 mb-2">
                <div class="rent-item active mb-4">
                    <img class="img-fluid mb-4" src="Website/img/car-rent-2.png" alt="">
                    <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                    <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                            <i class="fa fa-car text-primary mr-1"></i>
            ...
            <div class="col-lg-4 col-md-6 mb-2">
                <div class="rent-item mb-4">
                    <img class="img-fluid mb-4" src="Website/img/car-rent-3.png" alt="">
                    <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                    <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                            <i class="fa fa-car text-primary mr-1"></i>
            ...
            <div class="col-lg-4 col-md-6 mb-2">
                <div class="rent-item mb-4">
                    <img class="img-fluid mb-4" src="Website/img/car-rent-4.png" alt="">
                    <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                    <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                            <i class="fa fa-car text-primary mr-1"></i>
            ...
            <div class="col-lg-4 col-md-6 mb-2">
                <div class="rent-item mb-4">
                    <img class="img-fluid mb-4" src="Website/img/car-rent-5.png" alt="">
                    <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                    <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                            <i class="fa fa-car text-primary mr-1"></i>
            ...
            <div class="col-lg-4 col-md-6 mb-2">
                <div class="rent-item mb-4">
                    <img class="img-fluid mb-4" src="Website/img/car-rent-6.png" alt="">
                    <h4 class="text-uppercase mb-4">Mercedes Benz R3</h4>
                    <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                            <i class="fa fa-car text-primary mr-1"></i>
    ...
    <div class="container py-5">
        <div class="owl-carousel vendor-carousel">
            <div class="bg-light p-4">
                <img src="Website/img/vendor-1.png" alt="">
            </div>
            <div class="bg-light p-4">
                <img src="Website/img/vendor-2.png" alt="">
            </div>
            <div class="bg-light p-4">
                <img src="Website/img/vendor-3.png" alt="">
            </div>
            <div class="bg-light p-4">
                <img src="Website/img/vendor-4.png" alt="">
            </div>
            <div class="bg-light p-4">
                <img src="Website/img/vendor-5.png" alt="">
            </div>
            <div class="bg-light p-4">
                <img src="Website/img/vendor-6.png" alt="">
            </div>
            <div class="bg-light p-4">
                <img src="Website/img/vendor-7.png" alt="">
            </div>
            <div class="bg-light p-4">
                <img src="Website/img/vendor-8.png" alt="">
            </div>
        </div>
    </div>
</div>

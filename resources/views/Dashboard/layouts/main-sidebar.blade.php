			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('Cars.index')}}">All Cars</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='product-details') }}">Available Cars</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='product-cart') }}">Unavaliable Cars</a></li>
						</ul>
					</li>

                        ...
                        <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                            <div class="card-sigin">
                                <div class="mb-5 d-flex">
                                    ...
                                    <h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Drive<span>Wave</span></h1>
                                </div>
                                <div class="card-sigin">
                                    <div class="main-signup-header">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">{{ trans('Dashboard/login_trans.Login as:') }}</label>
                                            <select class="form-control" id="sectionChooser">
                                                <option value="" selected disabled>{{ trans('Dashboard/login_trans.Choose your role') }}</option>
                                        ...
                                        <div class="login-form" id="user">
                                            <h5 class="font-weight-semibold mb-4">{{ trans('Dashboard/login_trans.Login as User') }}</h5>
                                            <form method="POST" action="{{ route('login.user') }}">
                                                @csrf
                                                <div class="form-group">
                                                    <label>{{ trans('Dashboard/login_trans.Email') }}</label>
                                                    <input class="form-control" name="email" placeholder="{{ trans('Dashboard/login_trans.Enter your email') }}" type="email" :value="old('email')" required autofocus>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-main-primary btn-block">{{ trans('Dashboard/login_trans.Sign In') }}</button>
                                                <div class="row row-xs">
                                                    <div class="col-sm-6">
                                                        <button class="btn btn-block">
                                                            <i class="fab fa-facebook-f"></i> {{ trans('Dashboard/login_trans.Signup with Facebook') }}
                                                        </button>
                                                    </div>
                                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                                        <button class="btn btn-info btn-block">
                                                            <i class="fab fa-twitter"></i> {{ trans('Dashboard/login_trans.Signup with Twitter') }}
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
                                            <div class="main-signin-footer mt-5">
                                                ...
                                                <p>{{ trans('Dashboard/login_trans.Create an Account') }} <a href="{{ url('/' . $page='signup') }}">{{ trans('Dashboard/login_trans.Create an Account') }}</a></p>
                                            </div>
                                        </div>

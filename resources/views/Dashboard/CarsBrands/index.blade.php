                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <th class="wd-15p border-bottom-0">{{trans('Dashboard/carsbrands_trans.Brand Name')}}</th>
                                                <th class="wd-20p border-bottom-0">{{trans('Dashboard/carsbrands_trans.Country')}}</th>
                                                <th class="wd-20p border-bottom-0">{{trans('Dashboard/carsbrands_trans.Added Date')}}</th>
                                                <th class="wd-20p border-bottom-0">{{trans('Dashboard/carsbrands_trans.Actions')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                           @foreach($brands as $brand)
                                               <tr>
                                                   ...
                                                   <td>
                                                       <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"  data-toggle="modal" href="#edit{{$brand->id}}"><i class="las la-pen"></i></a>

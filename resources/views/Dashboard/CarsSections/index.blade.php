...
@section('title')
    {{trans('Dashboard/main-sidebar_trans.Cars Sections')}}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/main-sidebar_trans.Cars Sections')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/main-sidebar_trans.All Sections')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@include('Dashboard.messages_alert')
				<!-- row -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add">
                                            {{trans('Dashboard/carssection_trans.Add Section')}}
                                        </button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($cars_sections as $cars_section)
                                               ...
                                               @include('Dashboard.CarsSections.edit')
                                               @include('Dashboard.CarsSections.delete')
                    ...
                    @include('Dashboard.CarsSections.add')
                    <!-- /row -->
